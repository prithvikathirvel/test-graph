...
def parse_log_line(line: str):
    # Regex for: 2026-04-08 04:09:35 | INFO    | [flow:f96952] | app.main | Message
    # Handles: Timestamp | Level | [Context] | Module | Message
    ...
    # Fallback for multi-line logs or mismatched formats
